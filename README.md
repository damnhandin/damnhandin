...
один из которых использовало более <b>60&nbsp;000 пользователей</b>.
</p>
<p>
Работаю с <b>Aiogram 2/3</b>, асинхронным программированием, микросервисами 
и интеграцией AI (<b>OpenAI, YandexGPT, SunoAI, Gemini</b>).
</p>
<p>
...
с отправкой заявок на вебхук <b>Telegram-бота</b>, упакованные в <b>Docker-контейнер</b>.
</p>
<p>
В работе с базами данных активно использую <b>PostgreSQL</b> 
через <b>SQLAlchemy</b> или <b>asyncpg</b>. 
Всегда применяю <b>транзакции</b> для обеспечения целостности данных и корректного отката при ошибках, 
а также пишу максимально оптимизированные SQL-запросы.
</p>
<p>
Имею опыт как во <b>фриланс-проектах</b>, так и в <b>стартапах</b>: 
собирал команды, проектировал архитектуру и запускал продукты от идеи до продакшена.
</p>
<p>
...
чтобы выдерживать высокую нагрузку.
</p>
<p>
