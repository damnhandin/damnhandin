...
<p align="left">
Проекты, которые вы видите здесь в открытом доступе — это мои <b>самые простые, которые не жалко было показать</b><br>
Мои лучшие работы находятся в продакшне и доступны только узкому кругу лиц. <br><br>
